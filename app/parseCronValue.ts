...
export type TimeMetricType = 'minute'| 'hour'| 'dayOfTheMonth' | 'month' | 'dayOfTheWeek';

export const rangeBetween = (value: string, minValue: number, maxValue: number, minuteResult: { [key: number]: number; }) => {
...
export const stepValues = (value: string, minValue: number, maxValue: number, minuteResult: { [key: number]: number; }) => {
...
export const parseCronValue = (cronValue: string, timeMetric: TimeMetricType) => {
